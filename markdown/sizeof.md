...
## See also
the _[indirection](indirection.html) operator_ @, **[cheat](cheat.html)**, _[explicitIntegerConstant](explicitintegerconstant.html)_ (how to write hexadecimal constants), and pointers (in particular [unchecked](unchecked.html) pointers). See also **[addr](addr.html)**, which returns the address of a variable.
