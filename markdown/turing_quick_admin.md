...
**Note, if you have any questions not answered here, please check with the [turing_admin.html](Turing Teacher/Administrator's Complete Guide)for more information.**##Table of Contents
...
If there is no drive mapped to the student's home directory, or this method is not applicable to your system setup, please check with the [turing_admin.html#working_dir](Turing Teacher/Administrator's Complete Guide)for more information.
...
Turing 4.0 supports the **parallelput** and **parallelget** commandsto allow you to set the pins on the parallel port low and high.  If you arerunning under Windows NT, 2000 or XP, you will need to install a devicedriver on each machine.  Instructions for doing so can be found [turing_admin.html#parallel](here).  If **parallelput** and **parallelget** do not seem to function, you may need to change theirBIOS settings.  You can get information on how to do that [turing_admin.html#parallel](here).##4. Student Distribution of Turing 4.0
...
Permanent student redistribution licenses can be purchased for $500-$750 for most schools. If you are interested in purchasing a student redistribution license, contact Chris Stephenson at (416) 978-6476 or [mailto:chris@hsa.on.ca](chris@hsa.on.ca)##5. Technical Support
